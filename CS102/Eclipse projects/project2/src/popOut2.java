...
public class popOut2 {
	...
	boolean boardUpdate(char playerMove, int turn) {
		...
		while (true) {
			...
			System.out.print("\n" + turn + ". Enter column for " + playerMove
					+ " to play -> ");
			...
			// Convert userInput values from column and row into int
				...
				{
					System.out.println("Invalid colum entry. Please retry");
				}
				
				// Change alphabetical chars into int
				// code used to convert A...G to int for removal of the piece
				...
				for (int i = 0; i <= 6; i++) 
				{
					pieceTurn = (column % 7) + (i * 7);
					
				}
				
				// If piece is to be removed from the bottom
				int pieceTurn2 = (column % 7);
				for (int i = 6; i >= 0; i--) 
				{
					pieceTurn2 = pieceTurn ;
				}
				...
				if (turn == 1) 
				{
					...
					// Column 1
					// general set up: if square at position ____ is ' ', then
					// store the player's piece (X or O) to that location
					if (pieceTurn == 42) {
						if (getValue(35) == ' ') {
							setValue(playerMove, 35);
						} else if (getValue(28) == ' ') {
							setValue(playerMove, 28);
						} else if (getValue(21) == ' ') {
							setValue(playerMove, 21);
						} else if (getValue(14) == ' ') {
							setValue(playerMove, 14);
						} else if (getValue(7) == ' ') {
							setValue(playerMove, 7);
						} else if (getValue(0) == ' ') {
							setValue(playerMove, 0);
						} else {
							System.out.println("Invalid move. Column already full.");
						}
					}
					...
					if (pieceTurn == 43) {
						if (getValue(36) == ' ') {
							setValue(playerMove, 36);
						} else if (getValue(29) == ' ') {
							setValue(playerMove, 29);
						} else if (getValue(22) == ' ') {
							setValue(playerMove, 22);
						} else if (getValue(15) == ' ') {
							setValue(playerMove, 15);
						} else if (getValue(8) == ' ') {
							setValue(playerMove, 8);
						} else if (getValue(1) == ' ') {
							setValue(playerMove, 1);
						} else {
							System.out
									.println("Invalid move. Column already full.");
						}
					}
					...
					if (pieceTurn == 44) {
						...
						if (getValue(37) == ' ') {
							setValue(playerMove, 37);
						} else if (getValue(30) == ' ') {
							setValue(playerMove, 30);
						} else if (getValue(23) == ' ') {
							setValue(playerMove, 23);
						} else if (getValue(16) == ' ') {
							setValue(playerMove, 16);
						} else if (getValue(9) == ' ') {
							setValue(playerMove, 9);
						} else if (getValue(2) == ' ') {
							setValue(playerMove, 2);
						} else {
							System.out
									.println("Invalid move. Column already full.");
						}
					...
					if (pieceTurn == 45) {
						...
						if (getValue(38) == ' ') {
							setValue(playerMove, 38);
						} else if (getValue(31) == ' ') {
							setValue(playerMove, 31);
						} else if (getValue(24) == ' ') {
							setValue(playerMove, 24);
						} else if (getValue(17) == ' ') {
							setValue(playerMove, 17);
						} else if (getValue(10) == ' ') {
							setValue(playerMove, 10);
						} else if (getValue(3) == ' ') {
							setValue(playerMove, 3);
						} else {
							System.out
									.println("Invalid move. Column already full.");
						}
					...
					if (pieceTurn == 46) {
						...
						if (getValue(39) == ' ') {
							setValue(playerMove, 39);
						} else if (getValue(32) == ' ') {
							setValue(playerMove, 32);
						} else if (getValue(25) == ' ') {
							setValue(playerMove, 25);
						} else if (getValue(18) == ' ') {
							setValue(playerMove, 18);
						} else if (getValue(11) == ' ') {
							setValue(playerMove, 11);
						} else if (getValue(4) == ' ') {
							setValue(playerMove, 4);
						} else {
							System.out
									.println("Invalid move. Column already full.");
						}
					...
					if (pieceTurn == 47) {
						if (getValue(40) == ' ') {
							setValue(playerMove, 40);
						} else if (getValue(33) == ' ') {
							setValue(playerMove, 33);
						} else if (getValue(26) == ' ') {
							setValue(playerMove, 26);
						} else if (getValue(19) == ' ') {
							setValue(playerMove, 19);
						} else if (getValue(12) == ' ') {
							setValue(playerMove, 12);
						} else if (getValue(5) == ' ') {
							setValue(playerMove, 5);
						} else {
							System.out
									.println("Invalid move. Column already full.");
						}
					...
					if (pieceTurn == 48) {
						if (getValue(41) == ' ') {
							setValue(playerMove, 41);
						} else if (getValue(34) == ' ') {
							setValue(playerMove, 34);
						} else if (getValue(27) == ' ') {
							setValue(playerMove, 27);
						} else if (getValue(20) == ' ') {
							setValue(playerMove, 20);
						} else if (getValue(13) == ' ') {
							setValue(playerMove, 13);
						} else if (getValue(6) == ' ') {
							setValue(playerMove, 6);
						} else {
							System.out
									.println("Invalid move. Column already full.");
						}
					...
					break;
					// if the turn is not 1, then implement the following code
				} else {
